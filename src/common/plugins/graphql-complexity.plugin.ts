import { ApolloServerPlugin, BaseContext, GraphQLRequestContextDidResolveOperation, GraphQLServerContext } from '@apollo/server';
...
export class ComplexityPlugin implements ApolloServerPlugin {
  ...
  requestDidStart(): any {
    ...
    return {
      didResolveOperation: ({ request: { variables }, document }: GraphQLRequestContextDidResolveOperation<BaseContext>) => {
